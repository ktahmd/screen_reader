...
class GeminiTtsEngine implements ITtsEngine {
  ...
  Future<void> speak(String text) async {
    if (TtsService.config.geminiApiKey == null || TtsService.config.geminiApiKey!.isEmpty) {
    ...
    final String voiceName = TtsService.config.geminiVoice.replaceFirst(
        TtsService.config.geminiVoice[0],
        TtsService.config.geminiVoice[0].toUpperCase());
    ...
    final url = ApiEndpoints.geminiTts(TtsService.config.geminiModelTextToSpeechId, TtsService.config.geminiApiKey!);
